...
class FullGameUnitTest {
    ...
    fun threePlayersGame(){
        ...
        var game = GameModel(id = 1, startedAt = Date(), players = listOf(player1, player2, player3), rounds = rounds)
        val playersScoreRound1 = game.calculateScore()
        var player1Score = playersScoreRound1.find { it.first == player1 }?.second
        var player2Score = playersScoreRound1.find { it.first == player2 }?.second
        var player3Score = playersScoreRound1.find { it.first == player3 }?.second
        ...
        TestCase.assertEquals(-138, player1Score)
        TestCase.assertEquals(156, player2Score)
        TestCase.assertEquals(-18, player3Score)
        ...
        TestCase.assertEquals(-358, player1Score)
        TestCase.assertEquals(-64, player2Score)
        TestCase.assertEquals(422, player3Score)
